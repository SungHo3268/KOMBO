    ...
    if os.path.exists(typo_dir):
        ...
        for d_type in all_data_path:
            ...
            for i in range(len(dataset['label'])):
                ...
                sentence1 = generate_typo(sentence1, typo_type=typo_type, typo_level="jamo", typo_rate=typo_rate)
                sentence2 = generate_typo(sentence2, typo_type=typo_type, typo_level="jamo", typo_rate=typo_rate)
